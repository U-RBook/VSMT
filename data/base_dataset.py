...
def get_transform(opt, params=None, grayscale=False, method=Image.BICUBIC, convert=True, colorjitter=False):
    transform_list = []
    if grayscale:
    ...
    if colorjitter:
        transform_list += [transforms.ColorJitter(0.3,0.3,0.2)]
    if convert:
